      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-md mx-auto px-4 py-4">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold text-gray-800">{t('emergencyHelp')}</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        <Card className="mb-6 bg-gradient-to-r from-red-500 to-red-600 text-white">
          <div className="text-center py-4">
            ...
            <p className="text-red-100 mb-6">Press the button below for immediate assistance</p>
            <Button
              onClick={handleEmergencyCall}
              disabled={isEmergencyActive}
              className="bg-white text-red-600 hover:bg-gray-100 text-xl font-bold"
              size="xl"
            >
