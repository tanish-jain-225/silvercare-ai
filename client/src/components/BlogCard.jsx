...
export function BlogCard({ article }) {
  ...
  return (
    <motion.div
      className="group bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden h-full flex flex-col border border-gray-200 dark:border-gray-700"
      whileHover={{ y: -5 }}
      ...
      <div className="relative overflow-hidden h-48">
        {urlToImage ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center">
            <img src="/logo.png" alt="Logo" className="h-16 opacity-70" />
          </div>
        )}
