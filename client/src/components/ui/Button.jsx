...
export function Button({
  ...
  const baseClasses =
    "font-semibold rounded-2xl transition-all duration-200 focus:outline-none focus:ring-4 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-sm";
  ...
  const variantClasses = {
    ...
    outline:
      "border-2 border-gray-300 hover:border-blue-400 text-gray-700 bg-white focus:ring-blue-100",
