    ...
    <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center p-2 sm:p-4">
      <div className="container mx-auto w-full max-w-md md:max-w-lg lg:max-w-xl px-2 sm:px-4">
        <div className="text-center mb-4 sm:mb-6 md:mb-8">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 mb-1 sm:mb-2 break-words">SilverCare AI</h1>
          <p className="text-sm sm:text-base md:text-lg text-gray-600 break-words">{t('signup')}</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-7">
            ...
            <div className="relative flex items-center min-w-0">
              ...
              <div className="absolute inset-y-0 right-4 top-4 flex items-center pointer-events-auto">
                <VoiceButton onResult={handleVoiceInput('name')} size="sm" className="!w-9 sm:!w-10" />
              </div>
            </div>
            ...
            <div className="relative flex items-center min-w-0">
              ...
              />
              <div className="absolute inset-y-0 right-4 top-4 flex items-center pointer-events-auto">
                <VoiceButton onResult={handleVoiceInput('email')} size="sm" className="!w-9 sm:!w-10" />
              </div>
            </div>
            ...
            <div className="relative flex items-center min-w-0">
              ...
              />
              <div className="absolute inset-y-0 right-4 top-4 flex items-center pointer-events-auto">
                <VoiceButton onResult={handleVoiceInput('password')} size="sm" className="!w-9 sm:!w-10" />
              </div>
            </div>
