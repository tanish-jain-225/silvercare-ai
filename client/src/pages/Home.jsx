...
import { Calendar, Clock, AlertTriangle, MessageSquare, Bell, Heart } from 'lucide-react';
        ...
        <div className="container mx-auto w-full max-w-md md:max-w-lg lg:max-w-xl px-2 sm:px-4 py-4 sm:py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 text-sm sm:text-lg break-words">How can I help you today?</p>
            </div>
          </div>
        </div>
      </div>
          ...
          {features.map((feature) => (
            ...
            >
              <div className="text-center flex flex-col justify-center m-2">
                <div className={`inline-flex items-center justify-center w-10 sm:w-12 md:w-14 rounded-full mb-2 sm:mb-3 mx-auto ${feature.color}`}>
                  <feature.icon size={22} className="sm:size-24" />
                </div>
                <h3 className="text-base sm:text-lg md:text-xl font-semibold text-gray-800 mb-1 break-words">{feature.title}</h3>
                <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-tight break-words">{feature.description}</p>
              </div>
            </Card>
          ))}
        </div>
        ...
        <div className="mb-14">
          <Card className="bg-gradient-to-r from-green-500 to-emerald-600 text-white my-4">
            <div className="text-center">
              <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2 break-words">Daily Health Check</h3>
              <p className="text-green-100 mb-2 sm:mb-4 break-words">How are you feeling today?</p>
