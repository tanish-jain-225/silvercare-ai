...
export function ChatHistoryDemo() {
    ...
    const handleNewChat = () => {
        const newChat = {
            ...
            preview: "Start a new health consultation...",
            timestamp: new Date(),
            messageCount: 0
        };
                ...
                <div className="max-w-4xl w-full mx-auto">
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                aria-label={isHistoryPanelOpen ? "Hide chat history" : "Show chat history"}
                            >
                                {isHistoryPanelOpen ? (
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                                <h3 className="font-medium text-blue-900 dark:text-blue-100 mb-2">Panel State</h3>
                                <p className="text-blue-700 dark:text-blue-300">
                                    {isHistoryPanelOpen ? 'Open' : 'Closed'}
                                </p>
                            </div>
                            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                                <h3 className="font-medium text-green-900 dark:text-green-100 mb-2">Breakpoint</h3>
                                <p className="text-green-700 dark:text-green-300">
                                    {getCurrentBreakpoint()}
                                </p>
                            </div>
                            <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
                                <h3 className="font-medium text-purple-900 dark:text-purple-100 mb-2">Selected Chat</h3>
                                <p className="text-purple-700 dark:text-purple-300">
                                    {selectedChatId ? chatHistory.find(c => c.id === selectedChatId)?.title : 'None'}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-300">
                            <div>
                                <h3 className="font-medium text-gray-900 dark:text-white mb-2">Header Layout</h3>
                            ...
                            <div>
                                <h3 className="font-medium text-gray-900 dark:text-white mb-2">Responsive Behavior</h3>
                                <ul className="list-disc list-inside space-y-1 text-sm">
                                    <li>Large devices: Panel slides out, container expands to max-w-7xl</li>
                                    <li>Medium/Small devices: Panel overlays with close button</li>
                            ...
                            <div>
                                <h3 className="font-medium text-gray-900 dark:text-white mb-2">Mobile Enhancements</h3>
                                <ul className="list-disc list-inside space-y-1 text-sm">
