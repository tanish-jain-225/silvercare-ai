...
const resources = {
  ...
  es: {
    translation: {
      ...
      confirmDeleteEvent: "¿Estás seguro de que deseas eliminar este evento?",
      ...
      tryDifferentKeywords: "Intenta usar palabras clave diferentes",
  ...
  fr: {
    translation: {
      ...
      tryDifferentKeywords: "Essayez d'utiliser des mots-clés différents",
  ...
  hi: {
    translation: {
      ...
      exploreFeatures: "हमारी सुविधाओं का अन्वेषण करें",
      ...
      eventSaved: "कार्यक्रम सफलतापूर्वक सहेजा गया",
      ...
      retryLoading: "पुनः लोड करने का प्रयास करें",
      searchResults: "खोज परिणाम",
      noResultsFound: "कोई परिणाम नहीं मिला",
      tryDifferentKeywords: "विभिन्न कीवर्ड का उपयोग करने का प्रयास करें",
  ...
  bn: {
    translation: {
      ...
      howCanIHelp: "আমি আজ আপনার কিভাবে সাহায্য করতে পারি?",
      exploreFeatures: "আমাদের বৈশিষ্ট্যগুলি অন্বেষণ করুন",
      quickActions: "দ্রুত ক্রিয়াকলাপ",
      recentActivities: "সাম্প্রতিক কার্যকলাপ",
      notifications: "বিজ্ঞপ্তি",
      markAllAsRead: "সবগুলো পড়া হয়েছে মার্ক করুন",
      ...
      saveEvent: "ইভেন্ট সংরক্ষণ করুন",
      editEvent: "ইভেন্ট সম্পাদনা করুন",
      deleteEvent: "ইভেন্ট মুছে ফেলুন",
      confirmDeleteEvent: "আপনি কি সত্যিই এই ইভেন্টটি মুছে ফেলতে চান?",
      eventSaved: "ইভেন্ট সফলভাবে সংরক্ষিত হয়েছে",
      eventUpdated: "ইভেন্ট সফলভাবে আপডেট হয়েছে",
      eventDeleted: "ইভেন্ট সফলভাবে মুছে ফেলা হয়েছে",
      noDataAvailable: "কোনো ডেটা উপলব্ধ নেই",
      loadingData: "ডেটা লোড হচ্ছে...",
      errorLoadingData: "ডেটা লোড করতে ত্রুটি",
      retryLoading: "পুনরায় লোড করার চেষ্টা করুন",
      searchResults: "অনুসন্ধান ফলাফল",
      noResultsFound: "কোনো ফলাফল পাওয়া যায়নি",
      tryDifferentKeywords: "বিভিন্ন কীওয়ার্ড ব্যবহার করার চেষ্টা করুন",
      contactSupport: "সমর্থন যোগাযোগ করুন",
      faq: "প্রায়শই জিজ্ঞাসিত প্রশ্নাবলী",
      troubleshooting: "সমস্যা সমাধান",
      reportIssue: "একটি সমস্যা রিপোর্ট করুন",
      feedback: "প্রতিক্রিয়া",
      submitFeedback: "প্রতিক্রিয়া জমা দিন",
      thankYouFeedback: "আপনার প্রতিক্রিয়ার জন্য ধন্যবাদ!",
